...
The bot can tweet newly-tagged items, randomly-selected items, or both!
...
Browse the [Trove tag cloud](https://trove.nla.gov.au/tag) to see what's already in use. Have a look at the [Trove Help Zone](http://help.nla.gov.au/trove/using-trove/creating-contributing/adding-tags-comments#anchor-1) if you'd like to add your own tags.

Make sure your tags are all **public** (not private).
...
Just click on the huge 'Remix This' button below to create your very own copy of the `trove-tag-bot` code. Easy!

<a href="https://glitch.com/edit/#!/remix/trove-tag-bot">
  <img src="https://cdn.glitch.com/2bdfb3f8-05ef-4035-a06e-2043962a3a13%2Fremix-button.svg?1504724691606" alt="remix button" aria-label="remix" height="33">
</a>
...
`TAG` is just the Trove tag you want your bot to use in its searches. So for @TrovePoetryBot it's just:
